...
<div style="color: white;">
    <h2>Chat Height</h2>
    <input type="number" maxlength="100" id="height" style="width: 90%; height: 5%;" autocomplete="off" min="0" value="1" onchange="document.getElementById('chat').style.height = document.getElementById('height').value+'px'">
